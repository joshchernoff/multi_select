    ...
    <div>
      ...
      <div class="relative mt-2">
        <button
          ...
          type="button"
          class="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-1.5 pl-3 pr-2 text-left text-zinc-900 outline outline-1 -outline-offset-1 outline-zinc-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
